...
def main():
    ...
    # add by me: sunlifan
    file = '/root/CodeT5/CodeT5/refine_medium_codet5_base.bin'
    logger.info("Reload model from {}".format(file))
    model.load_state_dict(torch.load(file))
    # add by me end: sunlifan
    ...
    if args.do_test:
        ...
        for criteria in ['best-bleu']:
            file = "/root/CodeT5/CodeT5/sh/saved_models/refine/medium/codet5_base_all_lr5_bs16_src240_trg240_pat3_e25/checkpoint-best-bleu/pytorch_model.bin"
            logger.info("Reload model from {}".format(file))
            model.load_state_dict(torch.load(file))
